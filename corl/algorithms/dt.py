...
from corl.shared.utils import (get_trajectory_dataset, merge_dictionary,
                               wandb_init)
...
class TrainConfig:
    ...
    def __post_init__(self):
        ...
        elif (self.env.split('-')[0] == "pen"):
            self.target_returns: Tuple[float, ...] = (3100.0, )
        elif (self.env.split('-')[0] == "door"):
            self.target_returns: Tuple[float, ...] = (2900.0, )
        else:
...
def load_d4rl_trajectories(
    ...
    print("Dataset size: ", merged_dataset['observations'].shape[0])
