...
from REDQ.redq.algos.core import ReplayBuffer, ReplayTrajectoryBuffer
from REDQ.redq.algos.redq_sac import REDQSACAgent
...
class REDQRLPDAgent(REDQSACAgent):
    ...
    def __init__(self, diffusion_buffer_size=int(2e6), diffusion_sample_ratio=0.5, *args, **kwargs):
